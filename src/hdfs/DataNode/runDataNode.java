...
//		
//		Thread.sleep(1000 * 2);
//		DataNode dataNode3 = new DataNode(Hdfs.NameNode.nameNodeRegistryIP, Hdfs.NameNode.nameNodeRegistryPort, Hdfs.DataNode2.registryPort);
//		dataNode3.init();
//		Thread t3 = new Thread(dataNode3);
//		t3.start();
//		
//		Thread.sleep(1000 * 2);
//		DataNode dataNode4 = new DataNode(Hdfs.NameNode.nameNodeRegistryIP, Hdfs.NameNode.nameNodeRegistryPort, Hdfs.DataNode1.registryPort);
//		dataNode4.init();
