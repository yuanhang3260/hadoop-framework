...
public class HDFSNewOutputStream extends OutputStream implements Serializable {
	...
	public HDFSNewOutputStream (HDFSFile file, NameNodeRemoteInterface nameNodeStub) {
		this.file = file;
